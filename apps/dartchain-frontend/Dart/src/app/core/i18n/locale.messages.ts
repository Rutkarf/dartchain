...
const MESSAGES: Record<AppLocale, Record<LocaleKey, string>> = {
  fr: {
    ...
    'transactions.createTx': 'Créer une tx',
    ...
    'wallet.keys.show': 'Afficher',
    'wallet.keys.hide': 'Masquer',
    'wallet.keys.copy': 'Copier',
  ...
  en: {
    ...
    'wallet.keys.show': 'Show',
    'wallet.keys.hide': 'Hide',
    'wallet.keys.copy': 'Copy',

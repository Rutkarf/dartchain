...
|---|---|---|---|---|
| app-three-floor | Component | `three-floor/three-floor.ts` | YES | Host WebGL, renderer, rAF |
| app-character | Component | `three-floor/character/character.component.ts` | YES | Bootstrap avatar CharacterAnon |
| app-city-scene | Component | `three-floor/city-scene/city-scene.component.ts` | YES | Charge Marseille / legacy |
| app-joystick-move | Component | `three-floor/joystick-move/joystick-move.component.ts` | YES | Stick MOVE bas-gauche |
| app-joystick-view | Component | `three-floor/joystick-view/joystick-view.component.ts` | YES | Stick VIEW bas-droite |
| app-virtual-joystick | Component | `three-floor/joystick-shared/virtual-joystick.component.ts` | YES | Stick partagé MOVE/VIEW |
| app-placement-details-panel | Component | `three-floor/placement-details-panel/placement-details-panel.ts` | YES | HUD emplacement RDC |
...
Critère « other features » : import hors `three-floor/**`, `core/map/**`, `core/services/{three-scene,character-*,camera-control,runner}/**`.
...
- `three-floor/joystick-shared/{move,view}-joystick.input.ts`
- `three-floor/joystick-shared/virtual-joystick.pointer.ts`

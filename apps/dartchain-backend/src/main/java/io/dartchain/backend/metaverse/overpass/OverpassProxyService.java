...
public class OverpassProxyService {
    ...
    record OverpassEndpoint(String url, String userAgent) {}
     ...
     */
    static final List<OverpassEndpoint> ENDPOINTS = List.of(
    ...
    static boolean looksLikeOverpassJson(String body) {

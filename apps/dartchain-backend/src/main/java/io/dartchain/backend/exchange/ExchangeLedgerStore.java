...
/**
 * Persistance fichier du ledger exchange (simulateur testnet).
 *
 * @deprecated Conservé pour référence legacy (Phase R). Bean actif :
 * {@link io.dartchain.backend.exchange.JsonExchangeLedgerStore} via
 * {@link io.dartchain.backend.exchange.store.ExchangeLedgerStore}.
 */
@Deprecated(since = "0.4.0", forRemoval = false)
public class ExchangeLedgerStore {

    private static final Logger log = LoggerFactory.getLogger(ExchangeLedgerStore.class);

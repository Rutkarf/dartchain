...
/** Fond CSS global (palette marque) */
export const THEME_BG_BASE = BRAND.black.hex;

/** Scène particules — fond legacy */
export const THREE_SCENE_BG = hexToThree(THREE_LEGACY.sceneBg);
export const THREE_AMBIENT_DARK = hexToThree(THREE_LEGACY.sceneBg);
export const THREE_SCENE_CLEAR_LIGHT = hexToThree(THREE_LEGACY.sceneBg);

...
public class NewsService {
    ...
    public void seedEditorialNews() {
        ...
        items.add(editorial(
                ...
                "Explore la chaîne DART en temps réel.",
        ...
        items.add(editorial(
                "editorial-2",
                "R4V3",
                "Volume DART en hausse sur 24h",
                "Activité accrue sur la paire DART / R4V3.",
        ...
        items.add(editorial(
                "editorial-4",
                "Écosystème",
                "Faucet actif — 10 DART par claim",
                "Récupère des jetons pour tester les transactions.",
                "Le faucet distribue des DART de test pour alimenter ton wallet et expérimenter "
        ...
        items.add(editorial(
                ...
                "Crée un actif custom sur la chaîne DART.",
    ...
    public synchronized void publishSwapEvent(String walletAddress, io.dartchain.backend.dto.ExchangeSwapResponse swap) {
        Instant now = Instant.now();
        ...
        items.removeIf(item -> item.getId().startsWith("swap-") && item.getId().length() > 20);
